...
import { EVENT_USERS_BY_EVENT, POLLS_NO_RESULTS, ACTIVE_POLL } from '@/organizer/api/graphql/gql/queries'
import { CREATE_POLL, REMOVE_POLL, START_POLL, STOP_POLL } from '@/organizer/api/graphql/gql/mutations'
import {
